...
''.class''  files use a different versioning system, and have both a major and minor version. For example, J2SE v1.2 uses major version 46 and Java SE v17 uses major version 61 (as described, for example, on [[https://en.wikipedia.org/wiki/Java_class_file|Wikipedia]]).
