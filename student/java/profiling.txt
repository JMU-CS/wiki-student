...
To use the VisualVM for profiling/sampling:
  ...
  - Start the VisualVM (see below).
  - Execute your program (see below).
  - In the "Applications" pane, double-click on your program.
  - Click on either "Sampler" tab  or the "Profiler" tab (see below).
  - Click on <key>CPU</key> to start collecting data about CPU usage or <key>Memory</key> to start collecting data about memory usage (see below).
  - Use your program as appropriate.
  - Click on <key>Stop</key> to stop collecting data.
...
The VisualVM is very powerful and has a number of capabilities that are not discussed here. For more information, see the [[ https://visualvm.github.io/documentation.html |  current developer documentation ]] or the [[ https://docs.oracle.com/javase/8/docs/technotes/guides/visualvm/index.html |  original Oracle documentation ]].
