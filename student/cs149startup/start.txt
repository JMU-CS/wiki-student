...
jGRASP is very easy to download, install, and set-up (see how quickly [[https://youtube.com/playlist?list=PLv0EaZTS9xfkQ-WqFGcO8zGgIs-2KThBY|Dr. Bowers does it in this YouTube playlist]]). So that you do not also need to separately install a Java installation, we recommend you install the version of jGRASP that comes bundled with OpenJDK, which is the open source version of the Java development kit, as well as the Checkstyle and JUnit tools. 
...
Autolab is the software you will use to submit your code for programming assignments in CS 149. If you are on campus, or on the campus network, you simply go to [[https://autolab.cs.jmu.edu|https://autolab.cs.jmu.edu]] and log in with your EID.

Guides on using Autolab can be found [[student:autolab:start|here]].
