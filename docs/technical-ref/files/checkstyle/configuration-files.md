...
For more information about the kinds of checks that can be performed, see the [on-line documentation](http://checkstyle.sourceforge.net/checks.html).
...
[on-line documentation.](http://checkstyle.sourceforge.net/config_filefilters.html)
