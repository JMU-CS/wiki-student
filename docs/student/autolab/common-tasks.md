...
each course, the system shows its name, the semester, and the
...
course/assignment), and your submission history.

In some courses, you will also be able to click on "View writeup" to
see the details of the assignment and/or on "Download the handout" to
get any code/data that were provided for the assignment. In other courses you
...
Once the submission has been graded (i.e., when the points are listed
as numbers), you can click on any of them to get the feedback from the
automatic grading system. Note that, though there are different links,
